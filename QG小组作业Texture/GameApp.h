...
private:
	...
	ComPtr<ID3D11ShaderResourceView> m_p1;			    // 木盒纹理
	ComPtr<ID3D11ShaderResourceView> m_p2;              // 火焰纹理
	ComPtr<ID3D11ShaderResourceView> m_p3;
	ComPtr<ID3D11ShaderResourceView> m_p4;
	ComPtr<ID3D11ShaderResourceView> m_p5;
	ComPtr<ID3D11ShaderResourceView> m_p6;
